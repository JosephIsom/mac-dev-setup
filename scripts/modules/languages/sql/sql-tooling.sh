...
TARGET_SQL_NVIM_PLUGIN="$HOME/.config/nvim/lua/user/plugins/languages_sql.lua"
REPO_SQL_VSCODE_EXTENSIONS="$REPO_ROOT/scripts/modules/languages/sql/sql-vscode-extensions.txt"
TARGET_SQL_VSCODE_EXTENSIONS="$HOME/.config/vscode/extensions/sql-vscode-extensions.txt"
REPO_SQL_VSCODE_SETTINGS="$REPO_ROOT/scripts/modules/languages/sql/sql-vscode-settings.jsonc"
TARGET_SQL_VSCODE_SETTINGS="$HOME/.config/vscode/settings/sql-vscode-settings.jsonc"
