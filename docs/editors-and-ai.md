...
| `ai/github-copilot/github-copilot-cli.sh` | Optional | Installs GitHub Copilot CLI and VS Code assets. | Use `copilot` from the terminal and Copilot inside VS Code. | [GitHub Copilot CLI](https://cli.github.com/manual/gh_extension_install), [GitHub Copilot](https://github.com/features/copilot) | Sign in to GitHub and enable Copilot on your account. |
