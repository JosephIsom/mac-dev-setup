...
| Module | Default | What it does | How to use it | Links | Follow-up |
| --- | --- | --- | --- | --- | --- |
| `editors/cursor/cursor-app.sh` | On | Installs the Cursor desktop editor and writes managed Islands Dark settings. | Launch Cursor normally. | [Cursor](https://www.cursor.com/) | Sign in if you use Cursor’s hosted features. |
